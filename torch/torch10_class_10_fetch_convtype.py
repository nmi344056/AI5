...
print(x_train.size(), y_train.size())   # torch.Size([464809, 54]) torch.Size([464809])
print(x_test.size(), y_test.size())     # torch.Size([116203, 54]) torch.Size([116203])
...
'''
최종 loss : 1.3636302947998047
accuracy_score : 0.7147
accuracy_score : 0.7147
'''
