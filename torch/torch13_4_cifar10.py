...
print(train_dataset[0])         # (<PIL.Image.Image image mode=RGB size=32x32 at 0x16B47212D30>, 6)
print(train_dataset[0][0])      # <PIL.Image.Image image mode=RGB size=32x32 at 0x16B47212430>
...
x_train, x_test = x_train.permute(-1, 32*32*3), x_test.permute(-1, 32*32*3)
...
'''
loss, acc : (1.4505403719771022, 0.5192691693290735)
'''
