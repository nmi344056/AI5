...
class LSTM(nn.Module):
    def __init__(self):
        super().__init__()
        self.cell = nn.LSTM(input_size=1,            # 피쳐 갯수
    ...
    def forward(self, x):
        ...
        # c0 = torch.zeros(1, x.size(0), 32).to(DEVICE)   # (num_layers, batch_size, hidden_size)
...
[[10.332012]]
[10.332012]
[[ 8  9 10]]의 예측값 : 10.332012176513672
