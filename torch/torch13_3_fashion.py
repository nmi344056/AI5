...
print(train_dataset[0])         # (<PIL.Image.Image image mode=L size=28x28 at 0x24545A32D30>, 9)
print(train_dataset[0][0])      # <PIL.Image.Image image mode=L size=28x28 at 0x24545A32D30>

x_train, y_train = train_dataset.data/255., train_dataset.targets
x_test, y_test = test_dataset.data/255., test_dataset.targets

print(x_train)
print(y_train)  # tensor([9, 0, 0,  ..., 3, 0, 5])
...
'''
loss, acc : (0.4807118670152018, 0.8331669329073482)
'''
