...
x = torch.FloatTensor(x).unsqueeze(1).to(DEVICE)    # .to(DEVICE) 추가, = to torch.device('cuda')
...
데이터는 쿠다를 줬는데 모델은 cpu를 줬다, .to(DEVICE) 추가
'''
...
'''
epoch: 2000, loss : 4.263256414560601e-14
==============================
