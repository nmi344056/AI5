...
y = datasets.target - 1                 # 클래스 레이블을 0부터 시작하도록 조정
...
train_loader = DataLoader(train_set, batch_size=10240, shuffle=True)
test_loader = DataLoader(test_set, batch_size=10240, shuffle=False)
...
EPOCHS = 100       # 특정 수치를 대문자로 하는 경우 = 특정 상수, 고정한 상수, 값을 바꾸지 않겠다
...
'''
최종 loss : 1.3648969531059265
accuracy_score : 0.6899
'''
