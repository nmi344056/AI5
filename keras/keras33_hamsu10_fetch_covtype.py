...
dense5 = Dense(64, activation='relu', name='ys5')(drop4)
drop5 = Dropout(0.2)(dense5)
dense6 = Dense(64, activation='relu', name='ys6')(drop5)
drop6 = Dropout(0.2)(dense6)
dense7 = Dense(64, activation='relu', name='ys7')(drop6)
drop7 = Dropout(0.2)(dense7)
dense10 = Dense(64, activation='relu', name='ys10')(drop7)
drop8 = Dropout(0.1)(dense10)
dense11= Dense(64, activation='relu', name='ys11')(drop8)
drop9 = Dropout(0.1)(dense11)

output1 = Dense(7, activation='softmax', name='ys15')(drop9)
...
path ='C:/AI5/_save/keras32_mcp/10_fetch_covtype/'
filename = '{epoch:04d}-{val_loss:.4f}.hdf5'    # 1000-0.7777.hdf5    { } = dictionary, 키와 밸류  d는 정수, f는 소수
filepath = "".join([path, 'k32_10', date, '_', filename])      # 파일위치와 이름을 에포와 발로스로 나타내준다
