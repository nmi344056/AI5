...
dense1 = Dense(40,activation='relu',name='ys1')(input1)
drop1 = Dropout(0.3)(dense1)
dense2 = Dense(50, activation='relu',name='ys2')(drop1)
drop2 = Dropout(0.3)(dense2)
dense3 = Dense(60, activation='relu', name='ys3')(drop2)
drop3 = Dropout(0.3)(dense3)
dense4 = Dense(50, activation='relu', name='ys4')(drop3)
drop4 = Dropout(0.3)(dense4)
dense5 = Dense(40, activation='relu', name='ys5')(drop4)
dense6 = Dense(30, activation='relu', name='ys6')(dense5)
dense7 = Dense(20, activation='relu', name='ys7')(dense6)
dense8 = Dense(10, activation='relu', name='ys8')(dense7)
output1 = Dense(1, activation='sigmoid', name='ys9')(dense8)
