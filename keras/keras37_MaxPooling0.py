...
#2. 모델 구성
model = Sequential()
model.add(Conv2D(10, (3,3), activation='relu', input_shape=(28, 28, 1), strides=1)) # 26, 26, 10
model.add(MaxPooling2D(pool_size=3, padding='same'))        #13, 13, 10
model.add(Conv2D(filters=9, kernel_size=(3,3), activation='relu', strides=1, padding='valid'))  #11, 11, 9
model.add(Conv2D(8, (2,2), activation='relu', strides=1, padding='same'))   # 10, 10, 8
# model.add(Flatten())
