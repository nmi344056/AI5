...
#2. 모델 구성
model = Sequential()
model.add(Dense(128, activation='relu', input_shape=(32*32*3,)))   # (26, 26, 64)
...
filepath = "".join([path, 'k35_cnn6_date_', date, '_epo_', filename])
...
'''
cnn
loss :  1.0604807138442993 / accuracy :  0.628 / 

dnn
loss :  1.4337571859359741 / accuracy :  0.501 / time : 30.03 초
