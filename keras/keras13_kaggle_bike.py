...
sampleSubmission.to_csv(path + "sampleSubmission_0717_1320.csv")

print("loss : ", loss)

'''
64 32 32 16 1 / train_size=0.8, random_state=123 / epochs=100, batch_size=1000 / loss :  23073.974609375 (제출1)
