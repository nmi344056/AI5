...
filepath = "".join([path, 'k39_10_fetch_covtype_date_', date, '_epo_', filename])
...
start = time.time()
hist = model.fit(x_train, y_train, epochs=1, batch_size=300, validation_split=0.2, callbacks=[es, mcp])
end = time.time()
