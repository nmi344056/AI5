...
xy_data = train_datagen.flow(
    ...
    batch_size=augment_size,    # 주석하면 print(xy_data[0][0].shape)가 (32, 28, 28, 1), default=32
    shuffle=False,
)   # .next()

# [검색] np.tile

print(xy_data)              # <keras.preprocessing.image.NumpyArrayIterator object at 0x000002A6C4586F40>
