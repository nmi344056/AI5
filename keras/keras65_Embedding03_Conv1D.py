...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(filters=16, kernel_size=2, input_shape=(5, 1), strides=1, padding='same'))
...
filepath = "".join([path, 'k65_03_date_', date, '_epo_', filename])
