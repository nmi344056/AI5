...
filepath = "".join([path, 'k60_01_date_', date, '_epo_', filename])
...
start = time.time()
hist = model.fit(x_train, y_train, epochs=1, batch_size=10, validation_split=0.2, callbacks=[es, mcp])
end = time.time()
...
LSTM
loss :  58.56191635131836
r2 score :  0.31996494008431775
time :  66.01 초

Conv1D
loss :  457.52825927734375
r2 score :  -4.312928441992906
time :  2.28 초
