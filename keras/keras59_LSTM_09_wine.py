...
#2. 모델구성
model = Sequential()
model.add(LSTM(64, input_shape=(13,1), return_sequences=True, activation='relu'))
...
filepath = "".join([path, 'k39_09_wine_date_', date, '_epo_', filename])
...
LSTM
loss :  0.1475807 / accuracy :  0.722 / time :  469.53 초
