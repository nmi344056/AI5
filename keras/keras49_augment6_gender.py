...
x_test = np.concatenate((x_test_man, x_test_woman))
y_test = np.concatenate((y_test_man, y_test_woman))
print(x_test.shape, y_test.shape)                   # (7047, 100, 100, 3) (7047,)

print(np.unique(y_train, return_counts=True))
# (array([0., 1.], dtype=float32), array([14142, 14142], dtype=int64))
...
#  [4.0836659e-01]
#  [9.0715504e-01]]
print(y_test)                   # [0. 0. 0. ... 1. 1. 1.]
print(y_predict.shape)          # (7047, 1)
print(y_test.shape)             # (7047,)
...
augment
loss :  0.293230801820755 / accuracy :  0.877
