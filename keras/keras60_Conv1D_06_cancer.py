...
#2. 모델구성
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=3, input_shape=(10,3), activation='relu'))
...
filepath = "".join([path, 'k59_06_date_', date, '_epo_', filename])
...
LSTM
loss :  0.24354931712150574
accuracy :  0.895
time :  183.82 초

Conv1D
loss :  0.21184074878692627
accuracy :  0.939
time :  23.85 초
