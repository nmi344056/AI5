...
#2. 모델구성
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=3, input_shape=(8,1), activation='relu'))
...
filepath = "".join([path, 'k59_07_date_', date, '_epo_', filename])
...
LSTM
loss :  0.13972878456115723
accuracy :  0.802
time :  81.54 초

Conv1D
loss :  0.1586245894432068
accuracy :  0.763
time :  6.84 초
