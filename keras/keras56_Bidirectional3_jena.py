...
# #2. 모델구성
model = Sequential()
model.add(Bidirectional(LSTM(16, return_sequences=True), input_shape=(144,13)))
model.add(LSTM(32))
model.add(Dense(64))
model.add(Dense(128))
model.add(Dense(64))
...
'''
Bidirectional(LSTM
loss : 0.11028119176626205 / RMSE : 1.3283401781539719 ( 2276.41 초)
loss : 0.15545567870140076 / RMSE : 1.340183116886162 ( 2067.64 초)
loss : 0.16754837334156036 / RMSE : 1.3819420757438405 ( 1438.39 초)
loss : 0.2229343056678772 / RMSE : 1.453250157305132 ( 1568.33 초)
