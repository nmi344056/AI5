...
print(x_train.shape, y_train.shape)     # (60000, 28, 28) (60000,)  3차원(다차원)을 Dense로 받아드릴 수 있다.
...
# [실습] Conv2D로 시작해서 중간에 LSTM을 넣어서 

#2. 모델 구성
model = Sequential()
model.add(Dense(280, input_shape=(28, 28)))       # (n, 28, 28)
model.add(Reshape(target_shape=(28, 28, 10)))    # (n, 28, 28, 1) Dense로 받아들인 것이 4차원으로 reshape
...
=================================================================
 ...
 dense_1 (Dense)             (None, 32)                89632
 dense_2 (Dense)             (None, 10)                330
=================================================================
Total params: 92,862
Trainable params: 92,862
