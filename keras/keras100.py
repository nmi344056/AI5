...
model.fit(x_train, y_train, epochs=300, batch_size=1000, verbose=1, validation_split=0.2, callbacks=[es])
end = time.time()
...
submission_csv.to_csv(path + "sampleSubmission_0724_1525.csv")
