...
print("++++++++++++++++++++")
print("loss : ", loss[0], "/ accuracy : ", accuracy)
...
64-3,3  64-3,3-0.2  32-2,2  32-0.2  16 10 + relu / patience=20 / epochs=1000, batch_size=16 > loss :  0.0402994230389595 / accuracy :  0.987

stride_padding
64-3,3  64-3,3-0.2  32-2,2  32-0.2  16 10 + relu / patience=20 / epochs=1000, batch_size=16 > loss :  0.04876486212015152 / accuracy :  0.987

MaxPooling
loss :  0.0252341628074646 / accuracy :  0.9931

augment
loss :  0.03607327118515968 / accuracy :  0.9904

LSTM
loss :  0.05406113341450691 / accuracy :  0.9869
time : 593.12 초

Conv1D
loss :  0.06590856611728668 / accuracy :  0.9833
time : 570.76 초
